...
/**
 * @param {import('@stoplight/spectral-core').ISpectralDiagnostic} diagnostic
 * @returns
 */
const formatDiagnosticToString = ({
	...
	return `${formattedSeverity} ${message}
	at ${diagnosticPath} (${path.relative(path.dirname('.'), source)}:${range.start.line + 1}:${range.start.character + 1})`;
};
